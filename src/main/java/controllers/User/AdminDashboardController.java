...
// Set the items of the ComboBox
        ...
        /*
        // Attach listener to the textProperty of users_search TextField
        users_search.textProperty().addListener((observable, oldValue, newValue) -> {
            usersSearch(newValue); // Call usersSearch method with the new value
        });*/
    ...
    /*
    @FXML
    private void handleFileOwnersButton(ActionEvent event) {
        // Filter the TableView to show only file owners
        filteredUsers.setPredicate(user -> user.getRole() == role.fieldOwner);
    }
    @FXML
    private void handlePlayersButton(ActionEvent event) {
        // Filter the TableView to show only players
        filteredUsers.setPredicate(user -> user.getRole() == role.player);
    }
    @FXML
    private void handleAdminsButton(ActionEvent event) {
        // Filter the TableView to show only players
