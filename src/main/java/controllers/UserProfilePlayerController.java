...
public class UserProfilePlayerController {


    public AnchorPane side_bar_anchorpane;
    @FXML
    private Label player_email;
    ...
    public void initialize() {
        ...
        if (currentUser != null) {
            player_email.setText(currentUser.getEmail());
            player_name.textProperty().bind(Bindings.concat(currentUser.getFirstName(), " ", currentUser.getLastName()));
            File imageFile = new File(currentUser.getImage());
            Image img = new Image(imageFile.toURI().toString());
            player_img.setImage(img);
    ...
    public void updateUser(ActionEvent actionEvent) {
        ...
        if (!imagePath.isEmpty()) {
            ...
            if (success) {
                ...
                loadPage("/UserProfilePlayer/user_profile_player.fxml", actionEvent);
            }
        } else {
