...
public class ViewStadiumController {
    ...
    public void initialize() {
        ...
        stadiumTableView.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
            if (newValue != null) {
        ...
        reserveButton.setOnAction(event -> {
            ...
            if (selectedStadium != null) {
                makeReservation(selectedStadium.getReference());
            }
        });
    ...
    private void makeReservation(String ref) {
        try {
            SharedData.setStadiumref(ref);
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Reservation/ViewReservation.fxml"));
            ...
            public TableCell<Stadium, Void> call(TableColumn<Stadium, Void> param) {
                return new TableCell<>() {
                    ...
                    private final Button deleteButton = new Button("Delete");
                    {
                        ...
                        editButton.setPrefWidth(132);
                        deleteButton.setPrefHeight(30);
                        deleteButton.setPrefWidth(132);
                    }
